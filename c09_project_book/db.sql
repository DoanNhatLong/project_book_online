...
INSERT INTO book (name, price, stock, `desc`, id_author, id_category) VALUES
...
Gió nổi từ cuối Hán, tam phân thiên hạ từ đây mà thành.', 1, 2),
('Tây Du Ký', 140000, 40, 'Hành trình thỉnh kinh đầy huyền ảo và triết lý nhân sinh.', 2, 2),
...
Lòng người thì ước như vậy, nhưng trời có tuân theo lòng người chăng?',7,2),
...
cuộc chỉ là cách người đời gọi tên kẻ sống sót đến cuối con đường.',9,3),
('Hồng Lâu Mộng', 160000, 30, 'Bi kịch tình yêu và suy tàn của một gia tộc phong kiến.', 3, 1),
('Thủy Hử', 145000, 35, 'Câu chuyện anh hùng nghĩa khí thời loạn thế.', 4, 2),
('Anh Hùng Xạ Điêu', 170000, 45, 'Kiếm hiệp kinh điển với tinh thần chính nghĩa.', 5, 2),
('Thần Điêu Đại Hiệp', 175000, 40, 'Chuyện tình bi tráng giữa Dương Quá và Tiểu Long Nữ.', 5, 5),
('Tiếu Ngạo Giang Hồ', 165000, 38, 'Cuộc tranh đoạt quyền lực chốn giang hồ.', 6, 3),
('Bạch Dạ Hành', 155000, 25, 'Tiểu thuyết trinh thám – tâm lý đặc sắc.', 8, 2),
('Sống', 120000, 60, 'Tác phẩm nhân văn sâu sắc về số phận con người.', 10, 1),
('Không Gia Đình', 130000, 55, 'Câu chuyện cảm động về nghị lực và tình người.', 9, 2);
